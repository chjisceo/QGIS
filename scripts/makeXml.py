...
XML_TEMPLATE = '''
    <pyqgis_plugin name="{plugin_name}" version="{version}" plugin_id="{id}">
        ...
        <icon>https://chjisceo.github.io/harry-qgis.github.io/icons/{folder_name}/icon.png</icon>
        <author_name><![CDATA[{author_name}]]></author_name>
        <download_url>https://chjisceo.github.io/harry-qgis.github.io/download/{crr_zip_file}</download_url>
